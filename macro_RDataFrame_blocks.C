...
void macro_RDataFrame_blocks() {
	...
	if (bool_unfiltered) {
		...
		//
		hV0 = d.Histo1D({ "Name_hV0","Title_V0", nbins, -1e-6, 1e-2 }, "V0");
		//
		// 
		hBeamEnergy0 = d.Histo1D({ "Name_hBeamEnergy0","Title_hBeamEnergy0", nbins, 0, 220 }, "BeamEnergy0");
		//
		hECALtot = d.Histo1D({ "Name_hECALtot","Title_hECALtot", nbins, -1e-6, 190 }, "ECALtot");
		//
		hVHCALtot = d.Histo1D({ "Name_hVHCALtot","Title_hVHCALtot", nbins, -1e-6, 190 }, "VHCALtot");
		//
		hHCAL0tot = d.Histo1D({ "Name_hHCAL0tot","Title_hHCAL0tot", nbins, -1e-6, 190 }, "HCAL0tot");
		//
		hHCAL1tot = d.Histo1D({ "Name_hHCAL1tot","Title_hHCAL1tot", nbins, -1e-6, 190 }, "HCAL1tot");
		//
		for (int i = 0; i < n_ECALx; i++) {
			for (int j = 0; j < n_ECALy; j++) {
				int k = i + (j * n_ECALx);
				...
				hECALenergy[i][j] = d.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_VHCALx; i++) {
			for (int j = 0; j < n_VHCALy; j++) {
				...
				hVHCALenergy[i][j] = d.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				hHCAL0energy[i][j] = d.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				hHCAL1energy[i][j] = d.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		//
	...
	if (bool_S0S1) {
		...
		//
		hV0_cut_S0S1 = f_S0S1.Histo1D({ "V0 after cuts in S0 & S1","V0 after cuts in S0 & S1",nbins,-1e-6,1e-2 }, "V0");
		//
		// 
		hECALtot_cut_S0S1 = f_S0S1.Histo1D({ "Name_hECALtot_cut_S0S1","Title_hECALtot_cut_S0S1",nbins,-1e-6,190 }, "ECALtot");
		//
		hVHCALtot_cut_S0S1 = f_S0S1.Histo1D({ "Name_hVHCALtot_cut_S0S1","Title_hVHCALtot_cut_S0S1",nbins,-1e-6,190 }, "VHCALtot");
		//
		hHCAL0tot_cut_S0S1 = f_S0S1.Histo1D({ "Name_hHCAL0tot_cut_S0S1","Title_hHCAL0tot_cut_S0S1",nbins,-1e-6,190 }, "HCAL0tot");
		//
		hHCAL1tot_cut_S0S1 = f_S0S1.Histo1D({ "Name_hHCAL1tot_cut_S0S1","Title_hHCAL1tot_cut_S0S1",nbins,-1e-6,190 }, "HCAL1tot");
	...
	if (bool_S0S1antiV0) {
		...
		//
		hV0_cut_S0S1antiV0 = f_S0S1antiV0.Histo1D({ "V0 after cuts in S0, S1 & anti(V0)","V0 after cuts in S0, S1 & anti(V0)",nbins,-1e-6,1e-2 }, "V0");
		//
		// 
		hECALtot_cut_S0S1antiV0 = f_S0S1antiV0.Histo1D({ "Name_hECALtot_cut_S0S1antiV0","Title_hECALtot_cut_S0S1antiV0",nbins,-1e-6,190 }, "ECALtot");
		//
		hVHCALtot_cut_S0S1antiV0 = f_S0S1antiV0.Histo1D({ "Name_hVHCALtot_cut_S0S1antiV0","Title_hVHCALtot_cut_S0S1antiV0",nbins,-1e-6,190 }, "VHCALtot");
		//
		hHCAL0tot_cut_S0S1antiV0 = f_S0S1antiV0.Histo1D({ "Name_hHCAL0tot_cut_S0S1antiV0","Title_hHCAL0tot_cut_S0S1antiV0",nbins,-1e-6,190 }, "HCAL0tot");
		//
		hHCAL1tot_cut_S0S1antiV0 = f_S0S1antiV0.Histo1D({ "Name_hHCAL1tot_cut_S0S1antiV0","Title_hHCAL1tot_cut_S0S1antiV0",nbins,-1e-6,190 }, "HCAL1tot");
		//
		for (int i = 0; i < n_ECALx; i++) {
			for (int j = 0; j < n_ECALy; j++) {
				int k = i + (j * n_ECALx);
				...
				TString col = (TString)"ECALenergy_" + i_str + j_str;
				hECALenergy_cut_S0S1antiV0[i][j] = f_S0S1antiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_VHCALx; i++) {
			for (int j = 0; j < n_VHCALy; j++) {
				...
				TString col = (TString)"VHCALenergy_" + i_str + j_str;
				hVHCALenergy_cut_S0S1antiV0[i][j] = f_S0S1antiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL0energy_" + i_str + j_str;
				hHCAL0energy_cut_S0S1antiV0[i][j] = f_S0S1antiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL1energy_" + i_str + j_str;
				hHCAL1energy_cut_S0S1antiV0[i][j] = f_S0S1antiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		//
	...
	if (bool_antiS0S1) {
		...
		//
		hV0_cut_antiS0S1 = f_antiS0S1.Histo1D({ "V0 after cuts in anti(S0 & S1)","V0 after cuts in anti(S0 & S1)",nbins,-1e-6,1e-2 }, "V0");
		//
		// 
		hECALtot_cut_antiS0S1 = f_antiS0S1.Histo1D({ "Name_hECALtot_cut_antiS0S1","Title_hECALtot_cut_antiS0S1",nbins,-1e-6,190 }, "ECALtot");
		//
		hVHCALtot_cut_antiS0S1 = f_antiS0S1.Histo1D({ "Name_hVHCALtot_cut_antiS0S1","Title_hVHCALtot_cut_antiS0S1",nbins,-1e-6,190 }, "VHCALtot");
		//
		hHCAL0tot_cut_antiS0S1 = f_antiS0S1.Histo1D({ "Name_hHCAL0tot_cut_antiS0S1","Title_hHCAL0tot_cut_antiS0S1",nbins,-1e-6,190 }, "HCAL0tot");
		//
		hHCAL1tot_cut_antiS0S1 = f_antiS0S1.Histo1D({ "Name_hHCAL1tot_cut_antiS0S1","Title_hHCAL1tot_cut_antiS0S1",nbins,-1e-6,190 }, "HCAL1tot");
		//
		for (int i = 0; i < n_ECALx; i++) {
			for (int j = 0; j < n_ECALy; j++) {
				int k = i + (j * n_ECALx);
				...
				TString col = (TString)"ECALenergy_" + i_str + j_str;
				hECALenergy_cut_antiS0S1[i][j] = f_antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_VHCALx; i++) {
			for (int j = 0; j < n_VHCALy; j++) {
				...
				TString col = (TString)"VHCALenergy_" + i_str + j_str;
				hVHCALenergy_cut_antiS0S1[i][j] = f_antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL0energy_" + i_str + j_str;
				hHCAL0energy_cut_antiS0S1[i][j] = f_antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL1energy_" + i_str + j_str;
				hHCAL1energy_cut_antiS0S1[i][j] = f_antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		//
	...
	if (bool_S0S1V0) {
		...
		//
		hV0_cut_S0S1V0 = f_S0S1V0.Histo1D({ "Name_hV0","Title_V0",nbins,-1e-6,1e-2 }, "V0");
	...
	if (bool_S0S1S4SmuantiV0) {
		...
		//
		hV0_cut_S0S1S4SmuantiV0 = f_S0S1S4SmuantiV0.Histo1D({ "V0 after cuts in S0, S1, anti(V0), S4, Smu","V0 after cuts in S0, S1, anti(V0), S4, Smu",nbins,-1e-6,1e-2 }, "V0");
		//
		// 
		hECALtot_cut_S0S1S4SmuantiV0 = f_S0S1S4SmuantiV0.Histo1D({ "Name_hECALtot_cut_S0S1S4SmuantiV0","Title_hECALtot_cut_S0S1S4SmuantiV0",nbins,-1e-6,190 }, "ECALtot");
		//
		hVHCALtot_cut_S0S1S4SmuantiV0 = f_S0S1S4SmuantiV0.Histo1D({ "Name_hVHCALtot_cut_S0S1S4SmuantiV0","Title_hVHCALtot_cut_S0S1S4SmuantiV0",nbins,-1e-6,190 }, "VHCALtot");
		//
		hHCAL0tot_cut_S0S1S4SmuantiV0 = f_S0S1S4SmuantiV0.Histo1D({ "Name_hHCAL0tot_cut_S0S1S4SmuantiV0","Title_hHCAL0tot_cut_S0S1S4SmuantiV0",nbins,-1e-6,190 }, "HCAL0tot");
		//
		hHCAL1tot_cut_S0S1S4SmuantiV0 = f_S0S1S4SmuantiV0.Histo1D({ "Name_hHCAL1tot_cut_S0S1S4SmuantiV0","Title_hHCAL1tot_cut_S0S1S4SmuantiV0",nbins,-1e-6,190 }, "HCAL1tot");
		//
		for (int i = 0; i < n_ECALx; i++) {
			for (int j = 0; j < n_ECALy; j++) {
				int k = i + (j * n_ECALx);
		...
		for (int i = 0; i < n_VHCALx; i++) {
			for (int j = 0; j < n_VHCALy; j++) {
				...
				TString col = (TString)"VHCALenergy_" + i_str + j_str;
				hVHCALenergy_cut_S0S1S4SmuantiV0[i][j] = f_S0S1S4SmuantiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL0energy_" + i_str + j_str;
				hHCAL0energy_cut_S0S1S4SmuantiV0[i][j] = f_S0S1S4SmuantiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL1energy_" + i_str + j_str;
				hHCAL1energy_cut_S0S1S4SmuantiV0[i][j] = f_S0S1S4SmuantiV0.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		//
	...
	if (bool_S4antiS0S1) {
		...
		//
		hV0_cut_S4antiS0S1 = f_S4antiS0S1.Histo1D({ "V0 after cuts in S4, anti(S0, S1)","V0 after cuts in S4, anti(S0, S1)",nbins,-1e-6,1e-2 }, "V0");
		//
		// 
		hECALtot_cut_S4antiS0S1 = f_S4antiS0S1.Histo1D({ "Name_hECALtot_cut_S4antiS0S1","Title_hECALtot_cut_S4antiS0S1",nbins,-1e-6,190 }, "ECALtot");
		//
		hVHCALtot_cut_S4antiS0S1 = f_S4antiS0S1.Histo1D({ "Name_hVHCALtot_cut_S4antiS0S1","Title_hVHCALtot_cut_S4antiS0S1",nbins,-1e-6,190 }, "VHCALtot");
		//
		hHCAL0tot_cut_S4antiS0S1 = f_S4antiS0S1.Histo1D({ "Name_hHCAL0tot_cut_S4antiS0S1","Title_hHCAL0tot_cut_S4antiS0S1",nbins,-1e-6,190 }, "HCAL0tot");
		//
		hHCAL1tot_cut_S4antiS0S1 = f_S4antiS0S1.Histo1D({ "Name_hHCAL1tot_cut_S4antiS0S1","Title_hHCAL1tot_cut_S4antiS0S1",nbins,-1e-6,190 }, "HCAL1tot");
		//
		for (int i = 0; i < n_ECALx; i++) {
			for (int j = 0; j < n_ECALy; j++) {
				int k = i + (j * n_ECALx);
		...
		for (int i = 0; i < n_VHCALx; i++) {
			for (int j = 0; j < n_VHCALy; j++) {
				...
				TString col = (TString)"VHCALenergy_" + i_str + j_str;
				hVHCALenergy_cut_S4antiS0S1[i][j] = f_S4antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL0energy_" + i_str + j_str;
				hHCAL0energy_cut_S4antiS0S1[i][j] = f_S4antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		for (int i = 0; i < n_HCALx; i++) {
			for (int j = 0; j < n_HCALy; j++) {
				...
				TString col = (TString)"HCAL1energy_" + i_str + j_str;
				hHCAL1energy_cut_S4antiS0S1[i][j] = f_S4antiS0S1.Histo1D({ (TString)"Name_h" + str ,"Title_h" + str , nbins, -1e-6, 10 }, col);
			};
		};
		//
		//
